# TOOLS.md — every OSS tool registered for FreightForce

This file is the single inventory of every OSS tool wired up for FreightForce.
...
| networking | [graphhopper](networking/graphhopper/) | `networking/graphhopper/` (scaffold) |
...
| networking | [osrm](networking/osrm/) | `networking/osrm/` (scaffold) |
...
| domain-oss | [graphhopper](domain-oss/graphhopper/) | `domain-oss/graphhopper/` (deployable) |
| domain-oss | [openlr](domain-oss/openlr/) | `domain-oss/openlr/` (deployable) |
| domain-oss | [pinot-eta](domain-oss/pinot-eta/) | `domain-oss/pinot-eta/` (deployable) |
| domain-oss | [valhalla](domain-oss/valhalla/) | `domain-oss/valhalla/` (deployable) |
